# Notes and programs from "Pair programming with generative AI"

This repo contains the Jupyter notebook + files from my training for O'Reilly in January 2025.  It'll remain open, so you can review the material later on.
